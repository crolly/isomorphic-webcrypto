...
var liner = function (exports, asmCrypto, elliptic, require$$0) {
  ...
  var asn1 = createCommonjsModule(function (module, exports) {
    ...
    var LocalPrimitiveValueBlock = function (_ValueBlock) {
      ...
      function LocalPrimitiveValueBlock() {
        ...
        _this5.isHexOnly = (0, _pvutils.getParametersValue)(parameters, "isHexOnly", true);
        return _this5;
      }
  ...
  var AsnAnyConverter = {
    fromASN: function fromASN(value) {
      return value instanceof asn1.Null ? null : value.valueBeforeDecode;
    },
  ...
  var AsnUtf8StringConverter = createStringConverter(asn1.Utf8String);
  var AsnBmpStringConverter = createStringConverter(asn1.BmpString);
  var AsnUniversalStringConverter = createStringConverter(asn1.UniversalString);
  var AsnNumericStringConverter = createStringConverter(asn1.NumericString);
  var AsnPrintableStringConverter = createStringConverter(asn1.PrintableString);
  var AsnTeletexStringConverter = createStringConverter(asn1.TeletexString);
  var AsnVideotexStringConverter = createStringConverter(asn1.VideotexString);
  var AsnIA5StringConverter = createStringConverter(asn1.IA5String);
  var AsnGraphicStringConverter = createStringConverter(asn1.GraphicString);
  var AsnVisibleStringConverter = createStringConverter(asn1.VisibleString);
  var AsnGeneralStringConverter = createStringConverter(asn1.GeneralString);
  var AsnCharacterStringConverter = createStringConverter(asn1.CharacterString);
  var AsnUTCTimeConverter = {
    fromASN: function fromASN(value) {
      return value.toDate();
    },
    toASN: function toASN(value) {
      return new asn1.UTCTime({
        valueDate: value
      });
    }
  };
  var AsnGeneralizedTimeConverter = {
    ...
    toASN: function toASN(value) {
      return new asn1.GeneralizedTime({
        valueDate: value
      });
    }
  };
    ...
    _createClass(AsnSchemaStorage, [{
      ...
      value: function create(target, useNames) {
        ...
        for (var key in schema.items) {
          ...
          if (item.repeated) {
            asn1Item.name = "";
            var Container = item.repeated === "set" ? asn1.Set : asn1.Sequence;
          ...
          if (item.context !== null && item.context !== undefined) {
            if (item.implicit) {
              if (typeof item.type === "number" || isConvertible(item.type)) {
                var _Container = item.repeated ? asn1.Constructed : asn1.Primitive;
  ...
  var AsnParser = function () {
    ...
    _createClass(AsnParser, null, [{
      ...
      value: function parse(data, target) {
        ...
        var asn1Parsed = asn1.fromBER(buf);
      ...
      value: function fromASN(asn1Schema, target) {
        ...
        try {
          ...
          var asn1ComparedSchema = asn1.compareSchema(asn1Schema, asn1Schema, targetSchema);
          ...
          var _loop = function _loop(_key3) {
            ...
            if (typeof schemaItem.type === "number" || isConvertible(schemaItem.type)) {
              var _converter = (_a = schemaItem.converter) !== null && _a !== void 0 ? _a : isConvertible(schemaItem.type) ? new schemaItem.type() : null;
              ...
              if (schemaItem.repeated) {
                if (schemaItem.implicit) {
                  var Container = schemaItem.repeated === "sequence" ? asn1.Sequence : asn1.Set;
                  var newItem = new Container();
                  newItem.valueBlock = asn1Schema[_key3].valueBlock;
                  var _value2 = asn1.fromBER(newItem.toBER(false)).result.valueBlock.value;
                ...
                if (schemaItem.implicit) {
                  ...
                  _value3 = asn1.fromBER(_newItem.toBER(false)).result;
                }
      ...
      value: function toAsnItem(schemaItem, key, target, objProp) {
        ...
        if (typeof schemaItem.type === "number") {
          ...
          if (schemaItem.repeated) {
            ...
            var _Container2 = schemaItem.repeated === "sequence" ? asn1.Sequence : asn1.Set;
  ...
  var EdDsaProvider = function (_EllipticProvider3) {
    _inherits(EdDsaProvider, _EllipticProvider3);

    var _super82 = _createSuper(EdDsaProvider);
    ...
    function EdDsaProvider() {
      ...
      _this74.namedCurves = ["Ed25519", "Ed448"];
      return _this74;
    }
  ...
  var HmacProvider = function (_ProviderCrypto5) {
    ...
    var _super83 = _createSuper(HmacProvider);
  ...
  var Pbkdf2Provider = function (_ProviderCrypto6) {
    ...
    var _super84 = _createSuper(Pbkdf2Provider);
    ...
    function Pbkdf2Provider() {
      ...
      _this76.usages = ["deriveBits", "deriveKey"];
      return _this76;
    }
  ...
  var CryptoKey$1 = function (_CryptoKey) {
    ...
    var _super85 = _createSuper(CryptoKey$1);
    ...
    function CryptoKey$1(algorithm, extractable, type, usages) {
      ...
      _this77 = _super85.call(this);
      _this77.extractable = extractable;
      _this77.type = type;
      _this77.usages = usages;
      _this77.algorithm = Object.assign({}, algorithm);
      return _this77;
    }
  ...
  var AesCryptoKey = function (_CryptoKey$) {
    ...
    var _super86 = _createSuper(AesCryptoKey);
    ...
    function AesCryptoKey(algorithm, extractable, usages, raw) {
      ...
      _this78 = _super86.call(this, algorithm, extractable, "secret", usages);
      _this78.raw = raw;
      return _this78;
    }
            ...
            while (1) {
              switch (_context36.prev = _context36.next) {
                ...
                case 6:
                  ...
                  result = asmCrypto.AES_GCM[action](data, key.raw, _iv, additionalData, tagLength);
                  _context36.next = 18;
                  break;
  ...
  var AesCbcProvider$1 = function (_AesCbcProvider) {
    ...
    var _super87 = _createSuper(AesCbcProvider$1);
  ...
  var AesEcbProvider$1 = function (_AesEcbProvider) {
    ...
    var _super88 = _createSuper(AesEcbProvider$1);
  ...
  var AesGcmProvider$1 = function (_AesGcmProvider) {
    ...
    var _super89 = _createSuper(AesGcmProvider$1);
  ...
  var AesCtrProvider$1 = function (_AesCtrProvider) {
    ...
    var _super90 = _createSuper(AesCtrProvider$1);
          ...
          return regeneratorRuntime.wrap(function _callee52$(_context52) {
            while (1) {
              switch (_context52.prev = _context52.next) {
                case 0:
                  result = new asmCrypto.AES_CTR(key.raw, BufferSourceConverter.toUint8Array(algorithm.counter)).encrypt(BufferSourceConverter.toUint8Array(data));
          ...
          return regeneratorRuntime.wrap(function _callee53$(_context53) {
            while (1) {
              switch (_context53.prev = _context53.next) {
                case 0:
                  result = new asmCrypto.AES_CTR(key.raw, BufferSourceConverter.toUint8Array(algorithm.counter)).decrypt(BufferSourceConverter.toUint8Array(data));
  ...
  var AesKwProvider$1 = function (_AesKwProvider) {
    ...
    var _super91 = _createSuper(AesKwProvider$1);
  ...
  var RsaCryptoKey = function (_CryptoKey$2) {
    ...
    var _super92 = _createSuper(RsaCryptoKey);
    ...
    function RsaCryptoKey(algorithm, extractable, type, usages, data) {
      ...
      _this79 = _super92.call(this, algorithm, extractable, type, usages);
      _this79.data = data;
      return _this79;
    }
  ...
  var RsaCrypto = function () {
    ...
    _createClass(RsaCrypto, null, [{
              ...
              switch (_context62.prev = _context62.next) {
                ...
                case 7:
                  ...
                  return crypto.subtle.importKey("pkcs8", pkcs8, algorithm, extractable, keyUsages.filter(function (o) {
                    return _this80.privateUsages.includes(o);
                  }));
                ...
                case 13:
                  ...
                  return crypto.subtle.importKey("spki", spki, algorithm, true, keyUsages.filter(function (o) {
                    return _this80.publicUsages.includes(o);
                  }));
      ...
      value: function exportPkcs8Key(key) {
        var keyInfo = new index$2.PrivateKeyInfo();
      ...
      value: function importPkcs8Key(data) {
        var keyInfo = AsnConvert.parse(data, index$2.PrivateKeyInfo);
        var privateKey = AsnConvert.parse(keyInfo.privateKey, index$2.RsaPrivateKey);
        return this.importAsmKey(privateKey);
      }
    }, {
      key: "importSpkiKey",
      value: function importSpkiKey(data) {
        var keyInfo = AsnConvert.parse(data, index$2.PublicKeyInfo);
        var publicKey = AsnConvert.parse(keyInfo.publicKey, index$2.RsaPublicKey);
        return this.importAsmKey(publicKey);
      }
    }, {
      key: "exportSpkiKey",
      value: function exportSpkiKey(key) {
        var publicKey = new index$2.RsaPublicKey();
        ...
        var keyInfo = new index$2.PublicKeyInfo();
      ...
      value: function exportAsmKey(asmKey) {
        ...
        if (asmKey.length > 2) {
          var privateKey = new index$2.RsaPrivateKey();
  ...
  var RsaOaepProvider$1 = function (_RsaOaepProvider) {
    ...
    var _super93 = _createSuper(RsaOaepProvider$1);
    ...
    _createClass(RsaOaepProvider$1, [{
      ...
      value: function cipher(algorithm, key, data) {
        ...
        var cipher = new asmCrypto.RSA_OAEP(key.data, digest, label);
        var res;
  ...
  var RsaPssProvider$1 = function (_RsaPssProvider) {
    ...
    var _super94 = _createSuper(RsaPssProvider$1);
          ...
          return regeneratorRuntime.wrap(function _callee74$(_context74) {
            while (1) {
              switch (_context74.prev = _context74.next) {
                case 0:
                  rsa = new asmCrypto.RSA_PSS(key.data, ShaCrypto.getDigest(key.algorithm.hash.name), algorithm.saltLength);
  ...
  var RsaSsaProvider$1 = function (_RsaSsaProvider) {
    ...
    var _super95 = _createSuper(RsaSsaProvider$1);
          ...
          return regeneratorRuntime.wrap(function _callee79$(_context79) {
            while (1) {
              switch (_context79.prev = _context79.next) {
                case 0:
                  rsa = new asmCrypto.RSA_PKCS1_v1_5(key.data, ShaCrypto.getDigest(key.algorithm.hash.name));
                  result = rsa.sign(BufferSourceConverter.toUint8Array(data));
  ...
  var RsaEsProvider = function (_ProviderCrypto7) {
    ...
    var _super96 = _createSuper(RsaEsProvider);
    ...
    function RsaEsProvider() {
      ...
      _this81 = _super96.apply(this, arguments);
      _this81.name = "RSAES-PKCS1-v1_5";
      _this81.usages = {
        publicKey: ["encrypt", "wrapKey"],
        privateKey: ["decrypt", "unwrapKey"]
      };
      _this81.hashAlgorithms = ["SHA-1", "SHA-256", "SHA-384", "SHA-512"];
      return _this81;
    }
          ...
          return regeneratorRuntime.wrap(function _callee82$(_context82) {
            while (1) {
              switch (_context82.prev = _context82.next) {
                case 0:
                  EM = new asmCrypto.RSA(key.data).decrypt(new asmCrypto.BigNumber(BufferSourceConverter.toUint8Array(data))).result;
            ...
            while (1) {
              switch (_context83.prev = _context83.next) {
                ...
                case 3:
                  ...
                  result = new asmCrypto.RSA(key.data).encrypt(new asmCrypto.BigNumber(EM)).result;
  ...
  var EcCryptoKey = function (_CryptoKey$3) {
    ...
    var _super97 = _createSuper(EcCryptoKey);
    ...
    function EcCryptoKey(algorithm, extractable, type, usages, data) {
      ...
      _this82 = _super97.call(this, algorithm, extractable, type, usages);
      _this82.data = data;
      return _this82;
    }
  ...
  var EcCrypto = function () {
    ...
    _createClass(EcCrypto, null, [{
      ...
      value: function importPkcs8Key(data, namedCurve) {
        var keyInfo = AsnConvert.parse(data, index$2.PrivateKeyInfo);
        var privateKey = AsnConvert.parse(keyInfo.privateKey, index$2.EcPrivateKey);
      ...
      value: function importSpkiKey(data, namedCurve) {
        var keyInfo = AsnConvert.parse(data, index$2.PublicKeyInfo);
        var publicKey = new index$2.EcPublicKey(keyInfo.publicKey);
        return this.importEcKey(publicKey, namedCurve);
      }
    }, {
      key: "exportSpkiKey",
      value: function exportSpkiKey(key) {
        var publicKey = new index$2.EcPublicKey(new Uint8Array(key.data.getPublic("der")).buffer);
        var keyInfo = new index$2.PublicKeyInfo();
      ...
      value: function exportEcKey(ecKey) {
        if (ecKey.type === "private") {
          var privateKey = new index$2.EcPrivateKey();
  ...
  var EcdhProvider$1 = function (_EcdhProvider) {
    ...
    var _super98 = _createSuper(EcdhProvider$1);
  ...
  var EcdsaProvider$1 = function (_EcdsaProvider) {
    ...
    var _super99 = _createSuper(EcdsaProvider$1);
  ...
  var edOIDs = (_edOIDs = {}, _defineProperty(_edOIDs, index$2.idEd448, "Ed448"), _defineProperty(_edOIDs, "ed448", index$2.idEd448), _defineProperty(_edOIDs, index$2.idX448, "X448"), _defineProperty(_edOIDs, "x448", index$2.idX448), _defineProperty(_edOIDs, index$2.idEd25519, "Ed25519"), _defineProperty(_edOIDs, "ed25519", index$2.idEd25519), _defineProperty(_edOIDs, index$2.idX25519, "X25519"), _defineProperty(_edOIDs, "x25519", index$2.idX25519), _edOIDs);
  ...
  var EdPrivateKey = function (_CryptoKey$4) {
    _inherits(EdPrivateKey, _CryptoKey$4);

    var _super100 = _createSuper(EdPrivateKey);
    ...
    function EdPrivateKey(algorithm, extractable, usages, data) {
      ...
      _this84 = _super100.call(this, algorithm, extractable, "private", usages);
      _this84.data = data;
      return _this84;
    }
    ...
    _createClass(EdPrivateKey, [{
      ...
      value: function fromJSON(json) {
        ...
        if (/^ed/i.test(json.crv)) {
          var eddsa = new elliptic.eddsa(json.crv.toLowerCase());
          this.data = eddsa.keyFromSecret(hexPrivateKey);
        } else {
          var ecdhEs = elliptic.ec(json.crv.replace(/^x/i, "curve"));
  ...
  var EdPublicKey = function (_CryptoKey$5) {
    _inherits(EdPublicKey, _CryptoKey$5);

    var _super101 = _createSuper(EdPublicKey);
    ...
    function EdPublicKey(algorithm, extractable, usages, data) {
      ...
      _this85 = _super101.call(this, algorithm, extractable, "public", usages);
      _this85.data = data;
      return _this85;
    }
          ...
          return regeneratorRuntime.wrap(function _callee99$(_context99) {
            while (1) {
              switch (_context99.prev = _context99.next) {
                case 0:
                  this.checkLib();
                  curve = algorithm.namedCurve.toLowerCase() === "x25519" ? "curve25519" : "ed25519";

                  if (curve === "ed25519") {
                    raw = exports.nativeCrypto.getRandomValues(new Uint8Array(32));
                    eddsa = new elliptic.eddsa(curve);
                  ...
                  prvKey = new EdPrivateKey(algorithm, extractable, keyUsages.filter(function (usage) {
                    return _this86.privateKeyUsages.indexOf(usage) !== -1;
                  }), edKey);
                  pubKey = new EdPublicKey(algorithm, true, keyUsages.filter(function (usage) {
                    return _this86.publicKeyUsages.indexOf(usage) !== -1;
                  }), edKey);
          ...
          return regeneratorRuntime.wrap(function _callee103$(_context103) {
            while (1) {
              switch (_context103.prev = _context103.next) {
                ...
                case 5:
                  raw = Convert.FromHex(/^x/i.test(key.algorithm.namedCurve) ? key.data.getPrivate("hex") : key.data.getSecret("hex"));
                  keyInfo = new index$2.PrivateKeyInfo();
                ...
                case 10:
                  ...
                  _keyInfo = new index$2.PublicKeyInfo();
                  _keyInfo.publicKeyAlgorithm.algorithm = getOidByNamedCurve$1(key.algorithm.namedCurve);
          ...
          return regeneratorRuntime.wrap(function _callee104$(_context104) {
            while (1) {
              switch (_context104.prev = _context104.next) {
                ...
                case 14:
                  keyInfo = AsnConvert.parse(new Uint8Array(keyData), index$2.PublicKeyInfo);
                  return _context104.abrupt("return", this.importPublicKey(keyInfo.publicKey, algorithm, extractable, keyUsages));

                case 16:
                  _keyInfo2 = AsnConvert.parse(new Uint8Array(keyData), index$2.PrivateKeyInfo);
                  _asnKey = AsnConvert.parse(_keyInfo2.privateKey, index$2.CurvePrivateKey);
  ...
  var EdDsaProvider$1 = function (_EdDsaProvider) {
    _inherits(EdDsaProvider$1, _EdDsaProvider);

    var _super102 = _createSuper(EdDsaProvider$1);
    ...
    function EdDsaProvider$1() {
      ...
      _this87 = _super102.apply(this, arguments);
      _this87.namedCurves = ["Ed25519"];
      return _this87;
    }

    _createClass(EdDsaProvider$1, [{
      key: "onGenerateKey",
      value: function onGenerateKey(algorithm, extractable, keyUsages) {
  ...
  var Sha1Provider = function (_ProviderCrypto8) {
    ...
    var _super103 = _createSuper(Sha1Provider);
          ...
          return regeneratorRuntime.wrap(function _callee111$(_context111) {
            while (1) {
              switch (_context111.prev = _context111.next) {
                case 0:
                  return _context111.abrupt("return", ShaCrypto.digest(algorithm, data));
  ...
  var Sha256Provider = function (_Sha1Provider) {
    ...
    var _super104 = _createSuper(Sha256Provider);
  ...
  var Sha512Provider = function (_Sha1Provider2) {
    ...
    var _super105 = _createSuper(Sha512Provider);
  ...
  var PbkdfCryptoKey = function (_CryptoKey$6) {
    _inherits(PbkdfCryptoKey, _CryptoKey$6);

    var _super106 = _createSuper(PbkdfCryptoKey);
    ...
    function PbkdfCryptoKey(algorithm, extractable, usages, raw) {
      ...
      _this91 = _super106.call(this, algorithm, extractable, "secret", usages);
      _this91.raw = raw;
      return _this91;
    }
  ...
  var Pbkdf2Provider$1 = function (_Pbkdf2Provider) {
    ...
    var _super107 = _createSuper(Pbkdf2Provider$1);
          ...
          return regeneratorRuntime.wrap(function _callee112$(_context112) {
            while (1) {
              switch (_context112.prev = _context112.next) {
                case 0:
                  return _context112.abrupt("return", new PbkdfCryptoKey(algorithm, extractable, keyUsages, BufferSourceConverter.toUint8Array(keyData)));
            ...
            while (1) {
              switch (_context113.prev = _context113.next) {
                case 0:
                  ...
                  _context113.t0 = algorithm.hash.name.toUpperCase();
                  _context113.next = _context113.t0 === "SHA-1" ? 5 : _context113.t0 === "SHA-256" ? 7 : _context113.t0 === "SHA-512" ? 9 : 11;
                  break;

                case 5:
                  result = asmCrypto.Pbkdf2HmacSha1(password, salt, algorithm.iterations, length >> 3);
                  return _context113.abrupt("break", 12);
                ...
                case 12:
                  return _context113.abrupt("return", BufferSourceConverter.toArrayBuffer(result));
  ...
  var DesCryptoKey = function (_CryptoKey$7) {
    _inherits(DesCryptoKey, _CryptoKey$7);

    var _super108 = _createSuper(DesCryptoKey);
    ...
    function DesCryptoKey(algorithm, extractable, usages, raw) {
      ...
      _this92 = _super108.call(this, algorithm, extractable, "secret", usages);
      _this92.raw = raw;
      return _this92;
    }
            ...
            while (1) {
              switch (_context114.prev = _context114.next) {
                case 0:
                  this.checkLib();
                  raw = exports.nativeCrypto.getRandomValues(new Uint8Array(algorithm.length / 8));
                  return _context114.abrupt("return", new DesCryptoKey(algorithm, extractable, keyUsages, raw));
          ...
          return regeneratorRuntime.wrap(function _callee115$(_context115) {
            while (1) {
              switch (_context115.prev = _context115.next) {
                case 0:
                  this.checkLib();
                  _context115.t0 = format;
                  _context115.next = _context115.t0 === "jwk" ? 4 : _context115.t0 === "raw" ? 5 : 6;
                  break;

                case 4:
                  return _context115.abrupt("return", key.toJSON());

                case 5:
                  return _context115.abrupt("return", key.raw.buffer);
            ...
            while (1) {
              switch (_context116.prev = _context116.next) {
                ...
                case 4:
                  ...
                  return _context116.abrupt("return", key);
          ...
          return regeneratorRuntime.wrap(function _callee117$(_context117) {
            while (1) {
              switch (_context117.prev = _context117.next) {
                case 0:
                  return _context117.abrupt("return", this.cipher(algorithm, key, data, true));
          ...
          return regeneratorRuntime.wrap(function _callee118$(_context118) {
            while (1) {
              switch (_context118.prev = _context118.next) {
                case 0:
                  return _context118.abrupt("return", this.cipher(algorithm, key, data, false));
            ...
            while (1) {
              switch (_context119.prev = _context119.next) {
                case 0:
                  ...
                  iv = BufferSourceConverter.toUint8Array(algorithm.iv);
                  _context119.t0 = algorithm.name.toUpperCase();
                  _context119.next = _context119.t0 === "DES-CBC" ? 6 : _context119.t0 === "DES-EDE3-CBC" ? 8 : 10;
                  break;
                ...
                case 6:
                  ...
                  return _context119.abrupt("break", 11);
                ...
                case 11:
                  ...
                  return _context119.abrupt("return", new Uint8Array(enc).buffer);
  ...
  var DesCbcProvider = function (_DesProvider) {
    ...
    var _super109 = _createSuper(DesCbcProvider);
    ...
    function DesCbcProvider() {
      ...
      _this93 = _super109.apply(this, arguments);
      _this93.keySizeBits = 64;
      _this93.ivSize = 8;
      _this93.name = "DES-CBC";
      return _this93;
    }
          ...
          return regeneratorRuntime.wrap(function _callee120$(_context120) {
            while (1) {
              switch (_context120.prev = _context120.next) {
                case 0:
                  return _context120.abrupt("return", DesCrypto.generateKey(algorithm, extractable, keyUsages));
          ...
          return regeneratorRuntime.wrap(function _callee121$(_context121) {
            while (1) {
              switch (_context121.prev = _context121.next) {
                case 0:
                  return _context121.abrupt("return", DesCrypto.exportKey(format, key));
          ...
          return regeneratorRuntime.wrap(function _callee122$(_context122) {
            while (1) {
              switch (_context122.prev = _context122.next) {
                case 0:
                  return _context122.abrupt("return", DesCrypto.importKey(format, keyData, algorithm, extractable, keyUsages));
          ...
          return regeneratorRuntime.wrap(function _callee123$(_context123) {
            while (1) {
              switch (_context123.prev = _context123.next) {
                case 0:
                  return _context123.abrupt("return", DesCrypto.encrypt(algorithm, key, data));
          ...
          return regeneratorRuntime.wrap(function _callee124$(_context124) {
            while (1) {
              switch (_context124.prev = _context124.next) {
                case 0:
                  return _context124.abrupt("return", DesCrypto.decrypt(algorithm, key, data));
  ...
  var DesEde3CbcProvider = function (_DesProvider2) {
    ...
    var _super110 = _createSuper(DesEde3CbcProvider);
    ...
    function DesEde3CbcProvider() {
      ...
      _this94 = _super110.apply(this, arguments);
      _this94.keySizeBits = 192;
      _this94.ivSize = 8;
      _this94.name = "DES-EDE3-CBC";
      return _this94;
    }
          ...
          return regeneratorRuntime.wrap(function _callee125$(_context125) {
            while (1) {
              switch (_context125.prev = _context125.next) {
                case 0:
                  return _context125.abrupt("return", DesCrypto.generateKey(algorithm, extractable, keyUsages));
          ...
          return regeneratorRuntime.wrap(function _callee126$(_context126) {
            while (1) {
              switch (_context126.prev = _context126.next) {
                case 0:
                  return _context126.abrupt("return", DesCrypto.exportKey(format, key));
          ...
          return regeneratorRuntime.wrap(function _callee127$(_context127) {
            while (1) {
              switch (_context127.prev = _context127.next) {
                case 0:
                  return _context127.abrupt("return", DesCrypto.importKey(format, keyData, algorithm, extractable, keyUsages));
          ...
          return regeneratorRuntime.wrap(function _callee128$(_context128) {
            while (1) {
              switch (_context128.prev = _context128.next) {
                case 0:
                  return _context128.abrupt("return", DesCrypto.encrypt(algorithm, key, data));
          ...
          return regeneratorRuntime.wrap(function _callee129$(_context129) {
            while (1) {
              switch (_context129.prev = _context129.next) {
                case 0:
                  return _context129.abrupt("return", DesCrypto.decrypt(algorithm, key, data));
  ...
  var HmacCryptoKey = function (_CryptoKey$8) {
    _inherits(HmacCryptoKey, _CryptoKey$8);

    var _super111 = _createSuper(HmacCryptoKey);
    ...
    function HmacCryptoKey() {
      ...
      _this95 = _super111.call(this, algorithm, extractable, "secret", usages);
      _this95.kty = "oct";
      _this95.data = data;
      return _this95;
    }
  ...
  var HmacProvider$1 = function (_HmacProvider) {
    ...
    var _super112 = _createSuper(HmacProvider$1);
            ...
            while (1) {
              switch (_context130.prev = _context130.next) {
                case 0:
                  ...
                  return _context130.abrupt("return", key);
          ...
          return regeneratorRuntime.wrap(function _callee131$(_context131) {
            while (1) {
              switch (_context131.prev = _context131.next) {
                case 0:
                  _context131.t0 = key.algorithm.hash.name.toUpperCase();
                  _context131.next = _context131.t0 === "SHA-1" ? 3 : _context131.t0 === "SHA-256" ? 5 : _context131.t0 === "SHA-512" ? 7 : 9;
                  break;

                case 3:
                  fn = asmCrypto.HmacSha1;
                  return _context131.abrupt("break", 10);
                ...
                case 10:
                  ...
                  return _context131.abrupt("return", BufferSourceConverter.toArrayBuffer(result));
          ...
          return regeneratorRuntime.wrap(function _callee132$(_context132) {
            while (1) {
              switch (_context132.prev = _context132.next) {
                ...
                case 2:
                  signature2 = _context132.sent;
                  return _context132.abrupt("return", Convert.ToHex(signature2) === Convert.ToHex(signature));
          ...
          return regeneratorRuntime.wrap(function _callee133$(_context133) {
            while (1) {
              switch (_context133.prev = _context133.next) {
                case 0:
                  _context133.t0 = format.toLowerCase();
                  _context133.next = _context133.t0 === "jwk" ? 3 : _context133.t0 === "raw" ? 5 : 9;
                  break;
                ...
                case 3:
                  ...
                  return _context133.abrupt("break", 10);
          ...
          return regeneratorRuntime.wrap(function _callee134$(_context134) {
            while (1) {
              switch (_context134.prev = _context134.next) {
                case 0:
                  _context134.t0 = format.toLowerCase();
                  _context134.next = _context134.t0 === "jwk" ? 3 : _context134.t0 === "raw" ? 5 : 6;
                  break;

                case 3:
                  jwk = JsonSerializer.toJSON(key);
                  return _context134.abrupt("return", jwk);

                case 5:
                  return _context134.abrupt("return", new Uint8Array(key.data).buffer);
  ...
  var WrappedNativeCryptoKey = function (_CryptoKey$9) {
    _inherits(WrappedNativeCryptoKey, _CryptoKey$9);

    var _super113 = _createSuper(WrappedNativeCryptoKey);
    ...
    function WrappedNativeCryptoKey(algorithm, extractable, type, usages, nativeKey) {
      ...
      _this96 = _super113.call(this, algorithm, extractable, type, usages);

      _nativeKey.set(_assertThisInitialized(_this96), void 0);

      __classPrivateFieldSet(_assertThisInitialized(_this96), _nativeKey, nativeKey);
  ...
  var SubtleCrypto$1 = function (_SubtleCrypto) {
    ...
    var _super114 = _createSuper(SubtleCrypto$1);
    ...
    function SubtleCrypto$1() {
      ...
      _this97 = _super114.call(this);
      _this97.browserInfo = BrowserInfo();

      _this97.providers.set(new AesCbcProvider$1());

      _this97.providers.set(new AesCtrProvider$1());

      _this97.providers.set(new AesEcbProvider$1());

      _this97.providers.set(new AesGcmProvider$1());

      _this97.providers.set(new AesKwProvider$1());

      _this97.providers.set(new DesCbcProvider());

      _this97.providers.set(new DesEde3CbcProvider());

      _this97.providers.set(new RsaSsaProvider$1());

      _this97.providers.set(new RsaPssProvider$1());

      _this97.providers.set(new RsaOaepProvider$1());

      _this97.providers.set(new RsaEsProvider());

      _this97.providers.set(new EcdsaProvider$1());

      _this97.providers.set(new EcdhProvider$1());

      _this97.providers.set(new Sha1Provider());

      _this97.providers.set(new Sha256Provider());

      _this97.providers.set(new Sha512Provider());

      _this97.providers.set(new Pbkdf2Provider$1());

      _this97.providers.set(new HmacProvider$1());

      _this97.providers.set(new EdDsaProvider$1());
    ...
    _createClass(SubtleCrypto$1, [{
          ...
          return regeneratorRuntime.wrap(function _callee135$(_context135) {
            while (1) {
              switch (_context135.prev = _context135.next) {
                case 0:
                  return _context135.abrupt("return", this.wrapNative.apply(this, ["digest"].concat(args)));
            ...
            while (1) {
              switch (_context136.prev = _context136.next) {
                case 0:
                  ...
                  return _context136.abrupt("return", this.wrapNative.apply(this, ["importKey"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee138$(_context138) {
            while (1) {
              switch (_context138.prev = _context138.next) {
                case 0:
                  return _context138.abrupt("return", this.wrapNative.apply(this, ["generateKey"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee139$(_context139) {
            while (1) {
              switch (_context139.prev = _context139.next) {
                case 0:
                  return _context139.abrupt("return", this.wrapNative.apply(this, ["sign"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee140$(_context140) {
            while (1) {
              switch (_context140.prev = _context140.next) {
                case 0:
                  return _context140.abrupt("return", this.wrapNative.apply(this, ["verify"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee141$(_context141) {
            while (1) {
              switch (_context141.prev = _context141.next) {
                case 0:
                  return _context141.abrupt("return", this.wrapNative.apply(this, ["encrypt"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee142$(_context142) {
            while (1) {
              switch (_context142.prev = _context142.next) {
                case 0:
                  return _context142.abrupt("return", this.wrapNative.apply(this, ["decrypt"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee143$(_context143) {
            while (1) {
              switch (_context143.prev = _context143.next) {
                case 0:
                  return _context143.abrupt("return", this.wrapNative.apply(this, ["wrapKey"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee144$(_context144) {
            while (1) {
              switch (_context144.prev = _context144.next) {
                case 0:
                  return _context144.abrupt("return", this.wrapNative.apply(this, ["unwrapKey"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee145$(_context145) {
            while (1) {
              switch (_context145.prev = _context145.next) {
                case 0:
                  return _context145.abrupt("return", this.wrapNative.apply(this, ["deriveBits"].concat(args)));
          ...
          return regeneratorRuntime.wrap(function _callee146$(_context146) {
            while (1) {
              switch (_context146.prev = _context146.next) {
                case 0:
                  return _context146.abrupt("return", this.wrapNative.apply(this, ["deriveKey"].concat(args)));
      ...
      value: function wrapNative(method) {
        ...
        var _superIndex = function _superIndex(name) {
          return _get(_getPrototypeOf(SubtleCrypto$1.prototype), name, _this98);
        };
        ...
        return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee147() {
            ...
            while (1) {
              switch (_context147.prev = _context147.next) {
                ...
                case 7:
                  ...
                  return _context147.abrupt("return", this.fixNativeResult(method, args, res));
                ...
                case 11:
                  ...
                  Debug.warn("Error on native '".concat(method, "' calling. ").concat(_context147.t0.message), _context147.t0);
                ...
                case 23:
                  _res = _context147.sent;
                  return _context147.abrupt("return", _res);

                case 27:
                  _context147.prev = 27;
                  _context147.t1 = _context147["catch"](15);
                  Debug.warn("Cannot wrap key by native functions. ".concat(_context147.t1.message), _context147.t1);
                ...
                case 39:
                  _res2 = _context147.sent;
                  return _context147.abrupt("return", _res2);

                case 43:
                  _context147.prev = 43;
                  _context147.t2 = _context147["catch"](31);
                  Debug.warn("Cannot unwrap key by native functions. ".concat(_context147.t2.message), _context147.t2);
                ...
                case 51:
                  _data2 = _context147.sent;
                  _context147.next = 54;
                  return this.importKey("raw", _data2, args[2], args[3], args[4]);

                case 54:
                  _res3 = _context147.sent;
                  return _context147.abrupt("return", _res3);

                case 58:
                  _context147.prev = 58;
                  _context147.t3 = _context147["catch"](47);
                  Debug.warn("Cannot derive key by native functions. ".concat(_context147.t3.message), _context147.t3);
                ...
                case 75:
                  _context147.prev = 75;
                  _context147.t4 = _context147["catch"](63);

                  _iterator12.e(_context147.t4);
                ...
                case 91:
                  return _context147.abrupt("return", _superIndex(method).apply(this, args));
          ...
          }, _callee147, this, [[1, 11], [15, 27], [31, 43], [47, 58], [63, 75, 78, 81]]);
        }));
      }
    }, {
          ...
          return regeneratorRuntime.wrap(function _callee148$(_context148) {
            while (1) {
              switch (_context148.prev = _context148.next) {
                ...
                case 6:
                  jwk = _context148.sent;
                  return _context148.abrupt("return", provider.importKey("jwk", jwk, key.algorithm, true, key.usages));
      ...
      value: function fixFirefoxEcImportPkcs8(args) {
        ...
        if (this.browserInfo.name === Browser.Firefox && args[0] === "pkcs8" && ~["ECDSA", "ECDH"].indexOf(algName) && ~["P-256", "P-384", "P-521"].indexOf(preparedAlgorithm.namedCurve)) {
          ...
          var keyInfo = AsnConvert.parse(preparedData, index$2.PrivateKeyInfo);
          var privateKey = AsnConvert.parse(keyInfo.privateKey, index$2.EcPrivateKey);
            ...
            while (1) {
              switch (_context149.prev = _context149.next) {
                ...
                case 4:
                  ...
                  return _context149.abrupt("return", AsnConvert.serialize(keyInfo));
                ...
                case 13:
                  ...
                  Debug.error(_context149.t0);
                  return _context149.abrupt("return", null);
  ...
  var Crypto$1 = function (_Crypto) {
    ...
    var _super115 = _createSuper(Crypto$1);
    ...
    function Crypto$1() {
      ...
      _this99 = _super115.apply(this, arguments);
      _this99.subtle = new SubtleCrypto$1();
      return _this99;
    }
